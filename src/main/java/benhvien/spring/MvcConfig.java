...
import benhvien.validation.service.EmailValidator;
import benhvien.validation.service.PasswordMatchesValidator;

@Configuration
@ComponentScan(basePackages = { "benhvien.web.controller", "benhvien.persistence.service", "benhvien.persistence.dao" })
@EnableWebMvc
public class MvcConfig extends WebMvcConfigurerAdapter {
    ...
    public void addViewControllers(final ViewControllerRegistry registry) {
        ...
        registry.addViewController("/thongtinbenhnhan.html");
        registry.addViewController("/xemhosobenhan.html");
        //registry.addViewController("/traodoivoibacsy.html");
